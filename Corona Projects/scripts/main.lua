...
chao.id = "chao"
-- parametros para criar a box {x ref imagem, y ref a imagem, metade da largura box=, metade da altura box=, angulo da box=}
physics.addBody (chao, "static", {friction = 1, box = {x=0, y=0, halfWidth= 400, halfHeight=40}})
...
-- apos i segundo, cria-se a moeda1 = chame-se a função novaMoeda {script coletavel} (x=math.random, y=-100), repetições (0 é infinito), "nome do timer"
